...
export async function fetchAllTopologyData(creds: AwsCredentials): Promise<TopologyData> {
  ...
  let connections: DxConnection[] = [];
  let virtualInterfaces: TopologyData['virtualInterfaces'] = [];
  let lags: TopologyData['lags'] = [];
  let locations: TopologyData['locations'] = [];
  let vpcs: TopologyData['vpcs'] = [];
  let vpnGateways: TopologyData['vpnGateways'] = [];
  let transitGateways: TopologyData['transitGateways'] = [];
  let transitGatewayAttachments: TopologyData['transitGatewayAttachments'] = [];
  let transitGatewayPeeringAttachments: TopologyData['transitGatewayPeeringAttachments'] = [];
  let vpcPeerings: TopologyData['vpcPeerings'] = [];
  let vpnConnections: TopologyData['vpnConnections'] = [];
  let customerGateways: TopologyData['customerGateways'] = [];
